...
| Platform feature settings | 117 boolean definitions in `PLATFORM_FEATURE_DEFINITIONS` (docs/plan/flags.md audit: deleted test-stub flags, collapsed milestone/sub-flags into their parents) | Registry-wide UI/API/authz contract in `e2e/tests/platform-features-*.spec.ts` (see `e2e/README.md`) | [E2E.2](../completed/e2e/E2E.2-platform-feature-flag-contract.md) (completed) |
