...
fun courseSectionIcon(section: CourseWorkspaceSection): ImageVector = when (section) {
    ...
    CourseWorkspaceSection.Boards -> Icons.Filled.GridView
    CourseWorkspaceSection.LiveQuizzes -> Icons.Filled.RateReview
...
fun courseSectionLabelRes(section: CourseWorkspaceSection): Int = when (section) {
    ...
    CourseWorkspaceSection.LiveQuizzes -> R.string.mobile_ia_course_liveQuizzes
