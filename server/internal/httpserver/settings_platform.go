...
type platformSettingsJSON struct {
	...
	FFAssignToOverrides             bool `json:"ffAssignToOverrides"`
...
func (d Deps) handleGetPlatformSettings() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		out := platformSettingsJSON{
			...
			FFAssignToOverrides:             merged.FFAssignToOverrides,
...
func (d Deps) handlePutPlatformSettings() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		setBool("ffassigntooverrides", body.FFAssignToOverrides, func(v bool) { wr.FFAssignToOverrides = &v })
