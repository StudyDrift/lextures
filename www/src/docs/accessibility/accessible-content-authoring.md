---
title: "Authoring accessible course content"
...
supportTicketThemes: [accessibility-accessible-content-authoring]
relatedTo: [/docs/accessibility/automatic-accommodations, /docs/accessibility/wcag-22-aa-features, /docs/accessibility/setting-learner-accommodations]
contentContract: answer-first-v1
---

::: key-takeaways
- Use headings, link text, alternatives, captions, tables, and checks that help learners navigate course material.
