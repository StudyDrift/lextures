...
function CourseCatalogImportFromCourseModalInner({
  ...
  return (
    ...
    >
      <div className="flex max-h-[min(92vh,720px)] w-full max-w-lg flex-col overflow-hidden rounded-2xl border border-border-default bg-surface-raised shadow-xl dark:border-border-default dark:bg-surface-raised">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4">
          ...
          {step === 'form' ? (
            <>
              ...
              <label htmlFor={sourceId} className="block text-sm font-medium text-fg-default">
                Copy from
              </label>
              <select
                id={sourceId}
                ...
                className="mt-1.5 w-full rounded-xl border border-border-default bg-surface-raised px-3 py-2.5 text-sm text-fg-default shadow-sm outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-400/30 dark:border-border-default dark:bg-surface-base dark:text-fg-default"
              >
              ...
              <label htmlFor={nameId} className="mt-4 block text-sm font-medium text-fg-default">
                New course name
              </label>
              <input
                id={nameId}
              ...
              <fieldset className="mt-5 rounded-xl border border-border-default p-4 dark:border-border-default">
                ...
                <div className="mt-2 grid gap-2">
                  {INCLUDE_OPTIONS.map(({ key, label, hint }) => (
                    ...
                    >
                      ...
                      />
                      <span>
                        <span className="block text-sm font-medium text-fg-default">{label}</span>
