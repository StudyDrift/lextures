...
type platformSettingsJSON struct {
	...
	FFTypeScale                  bool    `json:"ffTypeScale"`
	FFNavigationV2               bool    `json:"ffNavigationV2"`
...
func (d Deps) handleGetPlatformSettings() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		out := platformSettingsJSON{
			...
			FFTypeScale:                        merged.FFTypeScale,
			FFNavigationV2:                     merged.FFNavigationV2,
...
func (d Deps) handlePutPlatformSettings() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		prevCourseMarketplace := d.effectiveConfig().FFCourseMarketplace
		...
		setBool("fftypescale", body.FFTypeScale, func(v bool) { wr.FFTypeScale = &v })
		setBool("ffnavigationv2", body.FFNavigationV2, func(v bool) { wr.FFNavigationV2 = &v })
		...
		if wr.FFCourseMarketplace != nil && merged.FFCourseMarketplace != prevCourseMarketplace {
			slog.Info("course marketplace flag toggled",
				"enabled", merged.FFCourseMarketplace,
