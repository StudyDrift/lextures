---
title: "Creating course coupons"
description: "Set a coupon value and validity window, test eligibility, and retire promotions without changing prior orders. Learn the key checks and safe next steps.."
date: 2026-08-11
updated: 2026-08-11
author: chase-willden
cluster: help-marketplace
primaryQuestion: "How do I use creating course coupons in Lextures?"
keywords: [Lextures, marketplace, help]
category: marketplace
roles: [instructor, admin]
segments: [k12, higher-ed, homeschool]
verifiedAgainst: "2026-08-11 source"
supportTicketThemes: [marketplace-creating-course-coupons]
relatedTo: [/docs/marketplace/publishing-course-listing, /docs/marketplace/understanding-payouts, /docs/marketplace/handling-refunds]
contentContract: answer-first-v1
---

::: key-takeaways
- Set a coupon value and validity window, test eligibility, and retire promotions without changing prior orders.
...
::: answer
Set a coupon value and validity window, test eligibility, and retire promotions without changing prior orders. Open the relevant settings, confirm your role permits the change, test with limited scope, and review the result from the affected user's view. Keep organization policy and learner privacy in the approval path.
:::
