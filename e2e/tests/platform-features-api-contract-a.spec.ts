/**
 * E2E.2 — platform feature API contract (shard A).
...
const entries = apiContractShards(3)[0]!

test.describe.serial('Platform features API contract A', () => {
  let gaToken = ''

  test.beforeAll(async () => {
    const email = uniqueEmail('plat-api-a')
  ...
  test(`shard a toggles ${entries.length} database-owned flags`, async () => {
