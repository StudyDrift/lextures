...
> Completed implementation. Source: [docs/plan/marketing-content/README.md](../../plan/marketing-content/README.md) §Plans; extends the
...
| **Status (today)** | **COMPLETED — implemented 2026-08-12** |
...
- Help article: [Translating a help article](../../runbooks/translating-marketing-content.md) (workflow, staleness, when to unpublish).
...
- Related plans: [MC.1](MC.1-content-data-model-and-migrations.md),
  ...
  [MC.12](MC.12-seo-parity-from-database.md), [MC.13](../../plan/marketing-content/MC.13-docs-search-and-in-app-help.md);
  [SEO.17](../seo/SEO.17-international-seo-and-hreflang.md).
