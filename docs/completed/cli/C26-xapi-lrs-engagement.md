...
> CLI parity plan. Source: `/api/v1/xapi/statements`, `admin/lrs-config`, `admin/lrs-dead-letter`, `/api/v1/scorm/rte/{registration_id}/commit`, `registerEngagementRoutes`, `/api/v1/recommendations/event`. Baseline: `clients/cli/cmd/xapi.go`, `engagement_events.go`, `recommendations.go`, extended `lrs.go`, `lrs_deadletter.go`, `scorm.go`, `xapi_lrs_engagement_logic.go`, `xapi_lrs_engagement_test.go`.
