...
func (d Deps) registerAdminRoutes(r chi.Router) {
	...
	// Collaboration boards admin governance (plan VC.10)
	r.Get("/api/v1/admin/boards/policies", d.handleAdminBoardPolicies())
	r.Patch("/api/v1/admin/boards/policies", d.handleAdminBoardPolicies())
	r.Get("/api/v1/admin/boards/overview", d.handleAdminBoardsOverview())
	// Live Quizzes admin governance (plan IQ.11)
	r.Get("/api/v1/admin/settings/interactive-quizzes", d.handleAdminIQSettings())
	r.Patch("/api/v1/admin/settings/interactive-quizzes", d.handleAdminIQSettings())
	r.Get("/api/v1/admin/org-units/{id}/interactive-quizzes", d.handleAdminOrgIQSettings())
	r.Patch("/api/v1/admin/org-units/{id}/interactive-quizzes", d.handleAdminOrgIQSettings())
	r.Get("/api/v1/admin/interactive-quizzes/analytics", d.handleAdminIQAnalytics())
	r.Get("/api/v1/admin/interactive-quizzes/review-queue", d.handleAdminIQReviewQueue())
	r.Post("/api/v1/admin/interactive-quizzes/review-queue/{id}/{action}", d.handleAdminIQReviewAction())
	r.Get("/api/v1/admin/interactive-quizzes/games", d.handleAdminIQLiveGames())
	r.Post("/api/v1/admin/interactive-quizzes/games/{game_id}/force-end", d.handleAdminIQForceEnd())
	r.Post("/api/v1/admin/interactive-quizzes/kits/bulk-archive", d.handleAdminIQBulkArchiveKits())
	...
	d.registerIntroCourseAdminRoutes(r)
	d.registerFeedbackAdminRoutes(r)
	d.registerAdminTokenRoutes(r)
	d.registerPlatformPeopleRoutes(r)
	d.registerPlatformCoursesRoutes(r)
}
