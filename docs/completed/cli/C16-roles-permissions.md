...
> CLI parity plan. Source: `registerSettingsRoutes` (`settings` RBAC, 23 routes), `rbac_settings.go`, `orgs/{orgId}/role-grants`, `me/permissions`, `me/org-role-capabilities`. Baseline: `clients/cli/cmd/roles.go`, `roles_logic.go`, `permissions.go`, `roles_test.go`.
