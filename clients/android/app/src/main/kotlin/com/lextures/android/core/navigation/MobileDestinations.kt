...
data class MobilePlatformFeatures(
    ...
    val ffMobileCourseCreateV2: Boolean = false,
    ...
    val ffMobileWhiteboardEdit: Boolean = false,
    val ffMobileMarketplacePurchase: Boolean = false,
    val ffMobileBoardsAdvanced: Boolean = false,
