...
func (d Deps) registerMeRoutes(r chi.Router) {
	...
	r.Get("/api/v1/me/device-tokens", d.handleGetMyDeviceTokens())
	r.Post("/api/v1/me/device-tokens", d.handlePostMyDeviceToken())
	r.Delete("/api/v1/me/device-tokens/{id}", d.handleDeleteMyDeviceToken())
