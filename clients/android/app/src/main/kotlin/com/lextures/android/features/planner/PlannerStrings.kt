...
fun calendarKindLabel(kind: PlannerCalendarEventKind): String = when (kind) {
    ...
    PlannerCalendarEventKind.LiveMeeting -> L.text(R.string.mobile_planner_kind_liveMeeting)
    PlannerCalendarEventKind.Conference -> L.text(R.string.mobile_planner_kind_conference)
}
