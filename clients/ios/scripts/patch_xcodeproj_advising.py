#!/usr/bin/env python3
"""Add M7.8 Academic Advising Swift files to the committed Xcode project."""
...
ENTRIES: list[tuple[str, str, str, str, bool]] = [
    ("AdvisingLogic.swift", "8B516C2D3E4F5061728394", "8B516D3E4F5061728394A5", "EE4734853C3443449D42D6DC", False),
    ("LMSFeatureModelsAdvising.swift", "8B512C2D3E4F5061728394", "8B512D3E4F5061728394A5", "EE4734853C3443449D42D6DC", False),
    ("LMSAPIAdvising.swift", "8B513C2D3E4F5061728394", "8B513D3E4F5061728394A5", "EE4734853C3443449D42D6DC", False),
    ("AdvisingView.swift", "8B514C2D3E4F5061728394", "8B514D3E4F5061728394A5", "8B51ADV5C6D7E8F901234567", False),
    ("AdvisingLogicTests.swift", "8B515C2D3E4F5061728394", "8B515D3E4F5061728394A5", "D177268EB0164406B86F0376", True),
]

NEW_GROUP = """
\t\t8B51ADV5C6D7E8F901234567 /* Advising */ = {
\t\t\tisa = PBXGroup;
\t\t\tchildren = (
\t\t\t\t8B514D3E4F5061728394A5 /* AdvisingView.swift */,
\t\t\t);
\t\t\tpath = Advising;
\t\t\tsourceTree = "<group>";
\t\t};
...
ADVISING_SUBGROUP = "8B51ADV5C6D7E8F901234567 /* Advising */"
LEAF_FEATURE_GROUPS = {"8B51ADV5C6D7E8F901234567"}
...
def main() -> None:
    ...
    text = insert_into_children(text, FEATURES_GROUP, ADVISING_SUBGROUP)

    if "8B51ADV5C6D7E8F901234567 /* Advising */ = {" not in text:
