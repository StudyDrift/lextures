...
> Implementation plan. Source: [docs/plan/seo/audit.md](audit.md) §S0 (F-2) and
...
| **Status (today)** | PARTIAL (prerenderer built and unit-tested, but disabled in CI via `SKIP_COURSE_PRERENDER=1`; no subject hubs, no instructor pages, no quality floor, no facet policy) |
...
([research §7](research.md#7-content-strategy-concentration-beats-volume-utility-beats-pages)). Course
...
([research §5](research.md#5-structured-data-what-still-pays-what-is-dead)).
...
- Audit findings: [F-2](audit.md#f-2-the-course-prerender-that-exists-is-disabled-in-production)
- Research: [§5](research.md#5-structured-data-what-still-pays-what-is-dead),
