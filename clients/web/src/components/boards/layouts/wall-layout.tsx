...
export function WallLayout(props: LayoutRendererProps) {
  ...
  return (
    <ul
      className="columns-1 gap-3 sm:columns-2 lg:columns-3 [column-fill:_balance]"
      aria-label={t('boards.layout.wall')}
    >
      {posts.map((post) => (
