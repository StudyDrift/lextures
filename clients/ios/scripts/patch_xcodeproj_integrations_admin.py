#!/usr/bin/env python3
"""Add M14.8 Integrations & Provisioning admin Swift files to the committed Xcode project."""
...
ENTRIES: list[tuple[str, str, str, str, bool]] = [
    ("LMSFeatureModelsIntegrationsAdmin.swift", "8B8A1C2D3E4F5061728394", "8B8A1D3E4F5061728394A5", "D7AC7435149B4B17A073AD6F", False),
    ("IntegrationsAdminLogic.swift", "8B8A2C2D3E4F5061728394", "8B8A2D3E4F5061728394A5", "D7AC7435149B4B17A073AD6F", False),
    ("IntegrationsAdminView.swift", "8B8A3C2D3E4F5061728394", "8B8A3D3E4F5061728394A5", "8B72ADM015C6D7E8F901234567", False),
    ("IntegrationsAdminEntryCard.swift", "8B8A4C2D3E4F5061728394", "8B8A4D3E4F5061728394A5", "029927E4F879434FA36100DE", False),
    ("IntegrationsAdminLogicTests.swift", "8B8A5C2D3E4F5061728394", "8B8A5D3E4F5061728394A5", "8D3F9FB222A34107B54468F2", True),
]
