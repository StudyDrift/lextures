#!/usr/bin/env python3
"""Add CT.M8 pack-4 Swift files to the committed Xcode project."""
...
FILES_APP = [
    ("ContentToolPack4Logic.swift", "LMS"),
    ("MediaCheckpointsToolView.swift", "Tools"),
    ("WorkedExampleToolView.swift", "Tools"),
    ("ParameterExplorerToolView.swift", "Tools"),
]
FILES_TEST = [
    ("ContentToolPack4LogicTests.swift", "Tests"),
]
...
def main() -> None:
    ...
    lms_group = find_group_containing(text, "ContentToolPack3Logic.swift")
    tools_group = find_group_containing(text, "SortSequenceToolView.swift")
    tests_group = find_group_containing(text, "ContentToolPack3LogicTests.swift")
    app_sources = find_sources_phase_containing(text, "ContentToolPack3Logic.swift")
    test_sources = find_sources_phase_containing(text, "ContentToolPack3LogicTests.swift")
    ...
    build_block = ""
    file_block = ""
    for name, group_key in FILES_APP + FILES_TEST:
