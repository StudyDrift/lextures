...
> Implementation plan. Source: [docs/plan/seo/audit.md](audit.md) §S4 (F-23).
...
| **Status (today)** | MISSING (English-only, `<html lang="en">` hard-coded, no `hreflang`, no locale routing) |
...
- In-product i18n — that is [UX.15](../ui-ux/UX.15-i18n-coverage-and-rtl-completion.md).
...
- **Coordinates with:** [UX.15](../ui-ux/UX.15-i18n-coverage-and-rtl-completion.md) — the marketing
...
1. Which locale first? Candidates on current evidence: `es` (US Spanish-speaking districts — arguably
   ...
   planned in [S14](../standards/S14-canada-pipeda-quebec-law25.md)), `en-gb`. Needs FR-10 data.
...
- Audit findings: [F-23](audit.md#f-23-no-internationalisation-signals)
- Research: [§1](research.md#1-the-structural-shift-retrieval-replaced-ranking) (retrieval is
  language-specific), [§4](research.md#4-entity-seo-is-the-highest-roieffort-ratio-available)
...
- Related plans: [SEO.1](SEO.1-static-rendering-and-crawlability.md),
  ...
  [UX.15 — i18n coverage & RTL](../ui-ux/UX.15-i18n-coverage-and-rtl-completion.md),
  [S14 — Canada / Quebec Law 25](../standards/S14-canada-pipeda-quebec-law25.md),
  [S20 — accessibility legal mandates](../standards/S20-accessibility-legal-mandates.md)
