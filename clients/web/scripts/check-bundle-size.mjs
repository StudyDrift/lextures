...
// 257 KiB + 512 B slack — Linux CI gzip can exceed macOS dev builds for the same artifact.
const entryMaxBytes = Number(process.env.ENTRY_MAX_JS_GZIP_BYTES ?? 257 * 1024 + 512)
