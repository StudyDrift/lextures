...
- No deletion of the markdown files — that is [MC.15](../../plan/marketing-content/MC.15-rollout-cutover-and-decommission.md),
...
- Related plans: [MC.7](../../plan/marketing-content/MC.7-www-build-time-content-integration.md),
  [MC.11](../../plan/marketing-content/MC.11-editorial-workflow-and-governance.md),
  [MC.15](../../plan/marketing-content/MC.15-rollout-cutover-and-decommission.md).
