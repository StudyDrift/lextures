...
func TestBuildInlineQuestionsWithAIRoute_Registered(t *testing.T) {
	signer := auth.NewJWTSigner("01234567890123456789012345678901")
	h := NewHandler(Deps{Pool: nil, JWTSigner: signer, Config: config.Config{}})
	path := "/api/v1/courses/demo/content-tools/instances/00000000-0000-0000-0000-000000000001/build-with-ai"
