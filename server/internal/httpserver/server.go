...
func NewHandler(d Deps) http.Handler {
	...
	d.registerMarketingArticleAIRoutes(r)
	...
	r.Post("/api/v1/live-quizzes/join/{code}/players", d.handleJoinQuizGuest())
	r.Get("/api/v1/live-quizzes/templates", d.handleListQuizTemplates())
	r.Post("/api/v1/live-quizzes/templates/{id}/create-kit", d.handleCreateKitFromTemplate())
	r.Get("/api/v1/live-quizzes/library", d.handleQuizLibrarySearch())
	r.Get("/api/v1/live-quizzes/library/{kit_id}/preview", d.handleQuizLibraryPreview())
	r.Post("/api/v1/live-quizzes/library/{kit_id}/import", d.handleQuizLibraryImport())
