...
> Implementation plan. Source: mobile parity for board engagement. Landscape: [visual-collaboration/README](../../plan/visual-collaboration/README.md). Mirrors web [VC.5](VC.5-reactions-comments-assessment.md); reuses the reaction/comment/grade REST endpoints and rides the VC.M4 notify channel for live counts.
...
- Related mobile plans: [VC.M2](VC.M2-mobile-posts-and-content.md), [VC.M4](VC.M4-mobile-realtime-and-presence.md), [VC.M6](VC.M6-mobile-sharing-access-attribution.md); grades [M6.1](../mobile/M6.1-grades-feedback.md).
