...
> CLI parity plan. Source: `registerCommunicationRoutes` (`communication`), `broadcasts_http.go` (`orgs/{orgId}/broadcasts`), `me/notifications`, `me/notification-preferences`, `me/push-subscriptions`, `me/device-tokens`, `push`. Baseline: `clients/cli/cmd/messaging_broadcasts.go`, `messaging_broadcasts_logic.go`, `messaging_broadcasts_test.go` (extends `feed.go`).
