...
> Foundational plan (cross-cutting). Source: `clients/cli/cmd/root.go`, `internal/client/client.go`, `internal/config`, `internal/auth`. Baseline: `clients/cli/internal/cli/*`, `clients/cli/cmd/cli_framework.go`, `cli_framework_test.go`.
