...
> Implementation plan. Source: net-new capability (interactive game-based quizzing). Landscape: [interactive-quizzes/README](../../plan/interactive-quizzes/README.md). Mirrors the admin/analytics/quotas/lifecycle pattern from Collaboration Boards ([VC.10](../../plan/visual-collaboration/VC.10-admin-analytics-quotas-lifecycle.md)) and plugs into the admin console, platform settings, and retention engine already in the platform.
...
- **FR-6.** **DSAR** integration ([S01](../../plan/standards/S01-unified-data-subject-rights-orchestration.md)): a
...
Migration `405_interactive_quizzes_governance.sql` (plus `406` guest-policy default):
...
- **Reuse:** `adminconsole` + `platform-settings-panel` / `platform-feature-definitions.ts` (UI),
  ...
  engines ([S01](../../plan/standards/S01-unified-data-subject-rights-orchestration.md)/[S02](../../plan/standards/S02-data-retention-deletion-engine.md)),
...
- Related plans: [IQ.1](IQ.1-foundation-and-feature-flag.md), [IQ.3](IQ.3-live-game-hosting-engine.md),
  [IQ.8](IQ.8-library-templates-sharing.md), [IQ.9](IQ.9-moderation-safety-accessibility.md),
  [IQ.10](IQ.10-ai-assisted-generation.md), [VC.10](../../plan/visual-collaboration/VC.10-admin-analytics-quotas-lifecycle.md);
  [S01 DSAR](../../plan/standards/S01-unified-data-subject-rights-orchestration.md), [S02 retention](../../plan/standards/S02-data-retention-deletion-engine.md).
