...
export function DocsCategory({ category: categoryId }: { category: string }) {
  ...
  return <div className="min-h-screen bg-white text-slate-900"><Header /><main>
    ...
    <section className="py-12" data-docs-category={categoryId}><div className="mx-auto max-w-5xl px-4 sm:px-6"><h2 className="text-2xl font-semibold">All {category.title.toLowerCase()} articles</h2><div className="mt-6 grid gap-4 sm:grid-cols-2" data-docs-article-list>
