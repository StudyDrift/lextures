    ...
    <div className="space-y-3">
      {bodyText ? (
        <div>
          ...
          <p className="mt-2 max-h-40 overflow-y-auto whitespace-pre-wrap rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-800 dark:border-neutral-600 dark:bg-neutral-950 dark:text-neutral-100">
            {bodyText}
          </p>
        </div>
      ) : null}
