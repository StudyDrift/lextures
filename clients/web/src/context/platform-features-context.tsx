    ...
    try {
      ...
      if (res.ok) {
        ...
        const next: PlatformFeaturesSnapshot = {
          ...
          ffNavigationV2: data.ffNavigationV2 === true,
          ...
          ffInteractiveQuizzes: true,
          screenShareEnabled: Boolean(data.screenShareEnabled),
        ...
        setFeatures({
          ...
          ffNavigationV2: next.ffNavigationV2 === true,
          ...
          ffInteractiveQuizzes: true,
          screenShareEnabled: Boolean(next.screenShareEnabled),
