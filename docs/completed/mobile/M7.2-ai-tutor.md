...
| **Status (today)** | **DONE** — floating course tutor FAB, streaming SSE chat (legacy + persistent sessions), Ask-AI with notebook RAG / study buddy, disclosure, token budget, stop/cancel, offline handling on iOS and Android |
| **Estimated effort** | M |
