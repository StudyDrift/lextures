  ...
  return (
    <div className={containerClass}>
      ...
      <button
        ...
        className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-border-strong px-3 py-2 text-xs font-semibold text-fg-muted hover:bg-surface-base dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-700"
      >
      ...
      {error ? (
        <p role="alert" className="w-full text-xs text-danger-fg dark:text-red-300">
          {error}
        </p>
      ) : null}
    </div>
