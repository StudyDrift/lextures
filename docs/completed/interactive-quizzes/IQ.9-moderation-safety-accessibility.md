...
> Completed implementation plan. Source: net-new capability (interactive game-based quizzing). Landscape: [interactive-quizzes/README](../../plan/interactive-quizzes/README.md) (active plans) / [completed index](README.md). Reuses list-based text moderation (`boardfilter` / content-filter path) and the shipped compliance engines under [`standards/`](../../plan/standards/); provides the enforcement hooks that [IQ.3](IQ.3-live-game-hosting-engine.md)/[IQ.4](IQ.4-player-join-and-gameplay.md) call.
...
- **FR-9.** For **under-13** contexts, guest join MUST honour the age-assurance/design-code guardrails in
  [S08](../../plan/standards/S08-childrens-privacy-age-assurance-design-codes.md) (no open public join for children;
...
Migration `403_interactive_quizzes_safety.sql`:
...
- **Reuse:** `contentfilter` (nickname + open-text moderation), the compliance engines
  ([S01](../../plan/standards/S01-unified-data-subject-rights-orchestration.md)/[S02](../../plan/standards/S02-data-retention-deletion-engine.md)/[S08](../../plan/standards/S08-childrens-privacy-age-assurance-design-codes.md)),
...
- **Sequencing:** migration `403` → moderation on join + host controls + a11y layer → a11y audit → enable
  guest-join sub-flag.
...
- Related plans: [IQ.3](IQ.3-live-game-hosting-engine.md), [IQ.4](IQ.4-player-join-and-gameplay.md),
