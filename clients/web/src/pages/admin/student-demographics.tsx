  ...
  if (featuresLoading) {
    return (
      <main className="mx-auto max-w-3xl p-6">
        <h1 className="text-xl font-bold text-fg-default">Student demographics</h1>
        ...
        <section className="mt-6" aria-labelledby={titleId}>
          {!hasFlags ? (
            ...
            <dl className="grid gap-3 text-sm">
              {record.freeLunch != null ? (
                <div className="flex justify-between border-b border-border-subtle py-2 dark:border-border-default">
                  <dt>Free lunch</dt>
