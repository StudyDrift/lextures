...
> Implementation plan. Source: [docs/plan/seo/audit.md](audit.md) §S3 (F-16, F-17, F-18).
...
([research §6](research.md#6-page-experience-the-bar-moved-up-in-march-2026)). Once SEO.1 makes every
...
- Server/app performance (`clients/web`) — that is [UX.17](../ui-ux/UX.17-perceived-performance-and-web-vitals-budget.md)
...
- **Privacy & Compliance** — removing Google Fonts eliminates an unnecessary IP disclosure to a third
  ...
  (coordinate with [S04](../standards/S04-unified-consent-preference-ledger.md)); the perf design
...
- **Must ship before:** no plan hard-blocks on it, but it MUST be in place before
  [SEO.7](SEO.7-help-center-expansion.md) and [SEO.8](SEO.8-editorial-engine-and-content-calendar.md)
...
2. Is a consent banner required in any market we serve? It materially changes the analytics loading
   strategy — needs an answer from [S04](../standards/S04-unified-consent-preference-ledger.md) /
   [S11](../standards/S11-us-state-privacy-expansion.md).
...
- Audit findings: [F-16, F-17, F-18](audit.md#s3--performance--ia)
- Research: [§6 Page experience: the bar moved up in March 2026](research.md#6-page-experience-the-bar-moved-up-in-march-2026)
...
- Related plans: [SEO.1](SEO.1-static-rendering-and-crawlability.md),
  ...
  [AN — motion & animation polish](../../completed/animations/)
