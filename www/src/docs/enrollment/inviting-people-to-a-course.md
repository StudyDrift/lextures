---
title: "Inviting people to a course"
...
supportTicketThemes: [enrollment-inviting-people-to-a-course]
relatedTo: [/docs/enrollment/sis-roster-sync, /docs/enrollment/managing-sections, /docs/enrollment/using-a-test-student]
contentContract: answer-first-v1
---

::: key-takeaways
- Invite learners and educators, assign the intended course role, and resolve pending or expired invitations.
