...
> Implementation plan. Source: bring the shipped web **Visual Collaboration Boards** (VC.1–VC.10) to the native mobile apps. Landscape: [visual-collaboration/README](../../plan/visual-collaboration/README.md). Mirrors the web foundation [VC.1](VC.1-foundation-and-feature-flag.md) on iOS (SwiftUI) and Android (Jetpack Compose), reusing the existing course-features flag plumbing and course-detail navigation.
...
- Web plan: [VC.1](VC.1-foundation-and-feature-flag.md).
- Existing mobile files: `clients/ios/Lextures/Core/LMS/{LMSModels,CourseFeaturesLogic}.swift`,
  ...
  `clients/ios/Lextures/Core/Routing/MobileDestinations.swift`, `docs/MOBILE_PLAN.md`.
- Related mobile plans: [VC.M2](VC.M2-mobile-posts-and-content.md),
  [VC.M4](VC.M4-mobile-realtime-and-presence.md).
