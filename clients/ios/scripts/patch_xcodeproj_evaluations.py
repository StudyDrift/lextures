#!/usr/bin/env python3
"""Add M7.7 Course Evaluations Swift files to the committed Xcode project."""
...
ENTRIES: list[tuple[str, str, str, str, bool]] = [
    ("EvaluationLogic.swift", "8B517C2D3E4F5061728394", "8B517D3E4F5061728394A5", "EE4734853C3443449D42D6DC", False),
    ("LMSFeatureModelsEvaluations.swift", "8B518C2D3E4F5061728394", "8B518D3E4F5061728394A5", "EE4734853C3443449D42D6DC", False),
    ("LMSAPIEvaluations.swift", "8B519C2D3E4F5061728394", "8B519D3E4F5061728394A5", "EE4734853C3443449D42D6DC", False),
    ("CourseEvaluationsSection.swift", "8B51AC2D3E4F5061728394", "8B51AD3E4F5061728394A5", "8B51EVA5C6D7E8F901234568", False),
    ("EvaluationFormView.swift", "8B51BC2D3E4F5061728394", "8B51BD3E4F5061728394A5", "8B51EVA5C6D7E8F901234568", False),
    ("EvaluationResultsView.swift", "8B51CC2D3E4F5061728394", "8B51CD3E4F5061728394A5", "8B51EVA5C6D7E8F901234568", False),
    ("EvaluationLogicTests.swift", "8B51DC2D3E4F5061728394", "8B51DD3E4F5061728394A5", "D177268EB0164406B86F0376", True),
]

NEW_GROUP = """
\t\t8B51EVA5C6D7E8F901234568 /* Evaluations */ = {
\t\t\tisa = PBXGroup;
\t\t\tchildren = (
\t\t\t\t8B51AD3E4F5061728394A5 /* CourseEvaluationsSection.swift */,
\t\t\t\t8B51BD3E4F5061728394A5 /* EvaluationFormView.swift */,
\t\t\t\t8B51CD3E4F5061728394A5 /* EvaluationResultsView.swift */,
\t\t\t);
\t\t\tpath = Evaluations;
\t\t\tsourceTree = "<group>";
\t\t};
...
EVALUATIONS_SUBGROUP = "8B51EVA5C6D7E8F901234568 /* Evaluations */"
LEAF_FEATURE_GROUPS = {"8B51EVA5C6D7E8F901234568"}
...
def main() -> None:
    ...
    text = insert_into_children(text, FEATURES_GROUP, EVALUATIONS_SUBGROUP)

    if "8B51EVA5C6D7E8F901234568 /* Evaluations */ = {" not in text:
