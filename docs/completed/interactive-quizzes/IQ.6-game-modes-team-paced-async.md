...
> Implementation plan. Source: net-new capability (interactive game-based quizzing). Landscape: [interactive-quizzes/README](../../plan/interactive-quizzes/README.md). Extends the state machine of [IQ.3](IQ.3-live-game-hosting-engine.md), the player flows of [IQ.4](IQ.4-player-join-and-gameplay.md), and the scoring of [IQ.5](IQ.5-scoring-leaderboards-mechanics.md).
...
Migration `400_interactive_quizzes_modes.sql` (plan reserved `395`; renumbered on merge — `395` was taken by transcripts):
...
- **Sequencing:** migration `400` → team mode → student-paced → async homework (gradebook scores land in `quizgame.assignment_grades`; IQ.7 syncs into `coursegrades`).
...
- Related plans: [IQ.3](IQ.3-live-game-hosting-engine.md), [IQ.4](IQ.4-player-join-and-gameplay.md),
  [IQ.5](IQ.5-scoring-leaderboards-mechanics.md), [IQ.7](../../plan/interactive-quizzes/IQ.7-reports-results-gradebook.md),
  [IQ.9](../../plan/interactive-quizzes/IQ.9-moderation-safety-accessibility.md).
