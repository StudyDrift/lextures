...
data class MobilePlatformFeatures(
    ...
    val ffMobileCreateCourse: Boolean = true,
    val ffMobileCourseCreateV2: Boolean = true,
    val ffMobileCanvasImport: Boolean = true,
    val ffMobileAdminConsole: Boolean = true,
    val ffMobileEnrollmentAdd: Boolean = true,
    val ffMobileLiveQuiz: Boolean = true,
    val ffMobileWhiteboardEdit: Boolean = true,
    val ffMobileMarketplacePurchase: Boolean = true,
    val ffMobileBoardsAdvanced: Boolean = true,
