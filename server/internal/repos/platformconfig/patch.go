...
func patch(ctx context.Context, pool *pgxpool.Pool, w *Write) error {
	...
	addBool("learner_profile_enabled", w.LearnerProfileEnabled)
	addBool("lp_adapt_recommendations", w.LpAdaptRecommendationsEnabled)
	addBool("lp_adapt_review", w.LpAdaptReviewEnabled)
	addBool("lp_adapt_modality", w.LpAdaptModalityEnabled)
	addBool("lp_adapt_tutor", w.LpAdaptTutorEnabled)
	addBool("intro_course_enabled", w.IntroCourseEnabled)
	...
	addBool("ff_mobile_admin_console", w.FFMobileAdminConsole)
	...
	addBool("ff_mobile_boards_advanced", w.FFMobileBoardsAdvanced)
	...
	addBool("ff_transcript_inbound", w.FFTranscriptInbound)
	addBool("ff_diplomas", w.FFDiplomas)
	...
	addBool("ff_visual_boards", w.FFVisualBoards)
	...
	addBool("ff_iq_homework", w.FFIqHomework)
	addBool("ff_iq_gradebook_push", w.FFIqGradebookPush)
	addBool("ff_iq_public_kit_catalog", w.FFIqPublicKitCatalog)
	addBool("ff_iq_guest_join", w.FFIqGuestJoin)
	addBool("ff_iq_ai_generation", w.FFIqAiGeneration)
