    ...
    <div className="space-y-8">
      <header className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0">
          <h2 className="flex items-center gap-2 text-lg font-semibold text-fg-default dark:text-white">
            <Award className="h-5 w-5 text-accent-fg" aria-hidden />
      ...
      <form onSubmit={(e) => void onCreate(e)} className="space-y-3 rounded-xl border border-border-default p-4 dark:border-slate-700">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-border-default px-3 py-2 text-sm dark:border-slate-600 dark:bg-slate-900"
          />
        </div>
        <div>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-accent-solid px-3 py-2 text-sm font-medium text-white hover:bg-indigo-500 disabled:opacity-60"
        >
        ...
        {definitions.map((d) => (
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <h3 className="font-semibold text-fg-default dark:text-white">{d.name}</h3>
              ...
              <button
                ...
                className="shrink-0 rounded-lg border border-border-strong px-3 py-1.5 text-sm font-medium hover:bg-surface-base dark:border-slate-600 dark:hover:bg-slate-700"
              >
                Award
              </button>
            </div>
            {d.description ? (
              <p className="mt-1 text-sm text-fg-muted dark:text-slate-300">{d.description}</p>
            ) : null}
          </li>
        ))}
      </ul>
      ...
      {awardDefId ? (
        ...
        >
          <div className="max-h-[80vh] w-full max-w-lg overflow-auto rounded-2xl bg-surface-raised p-5 shadow-xl dark:bg-slate-900">
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                type="button"
                className="rounded-lg border border-border-strong px-3 py-2 text-sm dark:border-slate-600"
              ...
              <button
                ...
                className="rounded-lg bg-accent-solid px-3 py-2 text-sm font-medium text-white disabled:opacity-60"
              >
