...
// ScormVisibleToStudent checks whether a scorm item is accessible to a student.
func ScormVisibleToStudent(
	...
	err := pool.QueryRow(ctx, `
		...
		WHERE el.id = $1 AND el.course_id = $2 AND el.kind = 'scorm'
