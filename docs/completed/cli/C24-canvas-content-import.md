...
> CLI parity plan. Source: `registerCanvasImportRoutes`, `canvas_import_queue.go`, `canvas_catalog.go`, `canvas_enrollment_import.go`, `canvas_grade_import.go`, `canvas_assignment_submissions_import.go`, `canvas_announcements_import.go`, `registerCanvasSubmissionSyncRoutes`, `courses/{id}/canvas-link`, `registerImportRoutes` (`imports`). Baseline: `clients/cli/cmd/canvas.go`, `canvas_content_import_logic.go`, `canvas_content_import_test.go`, extended `imports.go`.
