...
> Implementation plan. Source: mobile parity for board layouts. Landscape: [visual-collaboration/README](README.md). Mirrors web [VC.3](../../completed/visual-collaboration/VC.3-board-layouts-and-arrangement.md), adapting the seven layout modes to a small touch screen and reusing the REST arrange/sections endpoints.
...
- Web plan: [VC.3](../../completed/visual-collaboration/VC.3-board-layouts-and-arrangement.md); web layouts
