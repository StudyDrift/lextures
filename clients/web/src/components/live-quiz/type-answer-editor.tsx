        ...
        {accepted.map((a, index) => (
          <li key={index} className="flex flex-wrap items-center gap-2">
            <input
              ...
              className="min-h-11 min-w-[12rem] flex-1 rounded-md border border-border-strong px-3 py-2 text-sm dark:border-border-default dark:bg-surface-overlay dark:text-fg-default"
            />
            <select
              value={a.matchMode}
              disabled={disabled}
              ...
              className="min-h-11 rounded-md border border-border-strong px-2 py-2 text-sm dark:border-border-default dark:bg-surface-overlay dark:text-fg-default"
            ...
            {a.matchMode === 'fuzzy' ? (
              <input
                ...
                className="w-20 min-h-11 rounded-md border border-border-strong px-2 py-2 text-sm dark:border-border-default dark:bg-surface-overlay dark:text-fg-default"
