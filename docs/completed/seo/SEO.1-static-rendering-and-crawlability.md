...
> Implementation plan. Source: [docs/plan/seo/audit.md](../../plan/seo/audit.md) §S0 (F-1, F-2, F-3).
> **Shipped** 2026-08-11: route manifest, `generate-site.mjs` SSG, hydrateRoot, real 404, course API fallback. See `www/docs/site-generation.md`.
...
| **Severity** | BLOCKER |
| **Markets** | K12 / HE / HS |
| **Status (today)** | SHIPPED — full SSG via route manifest + generate-site (2026-08-11) |
...
([research §2](../../plan/seo/research.md#2-ai-crawlers-do-not-run-javascript)), receive nothing at all. The one
...
- **Internationalization** — the manifest carries an optional `locale` field, unused in this plan,
  reserved for [SEO.17](../../plan/seo/SEO.17-international-seo-and-hreflang.md).
...
- Research: [§2 AI crawlers do not run JavaScript](../../plan/seo/research.md#2-ai-crawlers-do-not-run-javascript)
...
- Related plans: [SEO.2](./SEO.2-crawler-access-sitemaps-and-llms-txt.md),
  [SEO.3](../../plan/seo/SEO.3-structured-data-and-entity-graph.md),
