...
> Implementation plan. Source: [docs/plan/seo/audit.md](audit.md) §S1 (F-4, F-5, F-6, F-7).
...
| **Severity** | BLOCKER |
| **Markets** | K12 / HE / HS |
| **Status (today)** | THIN (6-line robots.txt, one flat sitemap with build-date `lastmod`, no llms.txt, no Bing/IndexNow) |
...
citations on that engine ([research §2](research.md#2-ai-crawlers-do-not-run-javascript)); we are not
...
- **Must ship before:** [SEO.11](SEO.11-marketplace-catalog-seo.md) (catalog scale needs sharding),
  [SEO.15](SEO.15-measurement-search-console-and-ai-share-of-voice.md) (GSC/Bing are its data
  sources), [SEO.16](SEO.16-seo-governance-and-ci-guardrails.md) (parity check is a CI gate).
...
- Audit findings: [F-4, F-5, F-6, F-7](audit.md#s1--major-ai-search-readiness-is-absent)
- Research: [§2](research.md#2-ai-crawlers-do-not-run-javascript), [§9](research.md#9-measurement-in-2026)
