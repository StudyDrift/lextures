...
ENTRIES: list[tuple[str, str, str, str, bool]] = [
    ...
    ("PeerReviewLogic.swift", "A1B2C3D4E5F6478990A1B2C3D4", "B2C3D4E5F6A748990B1C2D3E4F5", "EE4734853C3443449D42D6DC", False),
    ("LMSFeatureModelsPeerReview.swift", "C3D4E5F6A7B84990C1D2E3F4A5B6", "D4E5F6A7B8C94091D2E3F4A5B6C7", "EE4734853C3443449D42D6DC", False),
    ("LMSAPIPeerReview.swift", "E5F6A7B8C9D04192E3F4A5B6C7D8", "F6A7B8C9D0E142A3F4A5B6C7D8E9", "EE4734853C3443449D42D6DC", False),
    ("PeerReviewListView.swift", "A7B8C9D0E1F243B4A5B6C7D8E9F0", "B8C9D0E1F2A344C5B6C7D8E9F0A1", "B1C2D3E4F5A6478990ABCDEF01", False),
    ("PeerReviewDetailView.swift", "C9D0E1F2A3B445D6C7D8E9F0A1B2", "D0E1F2A3B4C546E7D8E9F0A1B2C3", "B1C2D3E4F5A6478990ABCDEF01", False),
    ("ReviewsReceivedView.swift", "E1F2A3B4C5D647F8E9F0A1B2C3D4", "F2A3B4C5D6E748091A2B3C4D5E6F7", "B1C2D3E4F5A6478990ABCDEF01", False),
    ("RubricScorerView.swift", "A3B4C5D6E7F8491A2B3C4D5E6F7A8", "B4C5D6E7F8A942B3C4D5E6F7A8B9", "B1C2D3E4F5A6478990ABCDEF01", False),
    ("PeerReviewLogicTests.swift", "C5D6E7F8A9B043D4E5F6A7B8C9D0", "D6E7F8A9B0C144E5F6A7B8C9D0E1", "D177268EB0164406B86F0376", True),
]
...
\t\t\tsourceTree = "<group>";
\t\t};
\t\tB1C2D3E4F5A6478990ABCDEF01 /* PeerReview */ = {
\t\t\tisa = PBXGroup;
\t\t\tchildren = (
\t\t\t\tB8C9D0E1F2A344C5B6C7D8E9F0A1 /* PeerReviewListView.swift */,
\t\t\t\tD0E1F2A3B4C546E7D8E9F0A1B2C3 /* PeerReviewDetailView.swift */,
\t\t\t\tF2A3B4C5D6E748091A2B3C4D5E6F7 /* ReviewsReceivedView.swift */,
\t\t\t\tB4C5D6E7F8A942B3C4D5E6F7A8B9 /* RubricScorerView.swift */,
\t\t\t);
\t\t\tpath = PeerReview;
\t\t\tsourceTree = "<group>";
\t\t};
