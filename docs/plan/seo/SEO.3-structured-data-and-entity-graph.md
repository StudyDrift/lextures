...
> Implementation plan. Source: [docs/plan/seo/audit.md](audit.md) §S1 (F-8, F-9) and §S2 (F-11).
...
| **Severity** | MAJOR |
| **Markets** | K12 / HE / HS |
| **Status (today)** | THIN (one JSON-LD type, single hard-coded script id, on pages that do not ship; no brand entity; no named authors) |
...
([research §4](research.md#4-entity-seo-is-the-highest-roieffort-ratio-available)). Entity work is
...
- **FR-10.** Every page except the homepage MUST emit `BreadcrumbList` matching the visible
  breadcrumb trail introduced in [SEO.5](SEO.5-information-architecture-and-internal-linking.md).
...
- **Privacy & Compliance** — `Person` schema publishes real names and credentials; every author must
  ...
  ([S04](../standards/S04-unified-consent-preference-ledger.md)). No author's home location, personal
...
- `citation[]` on Article (FR-11) directly encodes the highest-impact factor from
  [research §3](research.md#3-what-actually-earns-an-ai-citation) (+132% from authoritative citations)
...
- **Must ship before:** [SEO.9](SEO.9-comparison-alternatives-and-integration-pages.md),
  [SEO.10](SEO.10-programmatic-utility-pages.md), [SEO.11](SEO.11-marketplace-catalog-seo.md),
  [SEO.12](SEO.12-original-research-and-data-program.md) (Dataset/ScholarlyArticle schema),
  [SEO.14](SEO.14-multimodal-video-images-and-social-assets.md) (VideoObject).
...
- Research: [§3](research.md#3-what-actually-earns-an-ai-citation),
  [§4](research.md#4-entity-seo-is-the-highest-roieffort-ratio-available),
  [§5](research.md#5-structured-data-what-still-pays-what-is-dead)
