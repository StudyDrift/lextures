/**
 * E2E.2 — platform feature API contract (shard B).
...
const entries = apiContractShards(3)[1]!

test.describe.serial('Platform features API contract B', () => {
  let gaToken = ''

  test.beforeAll(async () => {
    const email = uniqueEmail('plat-api-b')
  ...
  test(`shard b toggles ${entries.length} database-owned flags`, async () => {
