#!/usr/bin/env python3
"""Add MOB.6 whiteboard authoring Swift files to the committed Xcode project."""
...
ENTRIES: list[tuple[str, str, str, str, bool]] = [
    ("WhiteboardLogic.swift", "M760W01C2D3E4F5061728394", "M760W01D3E4F5061728394A5", "B62295116F7F4935A884363D", False),
    ("LMSAPIWhiteboard.swift", "M760W02C2D3E4F5061728394", "M760W02D3E4F5061728394A5", "B62295116F7F4935A884363D", False),
    ("WhiteboardLogicTests.swift", "M760W03C2D3E4F5061728394", "M760W03D3E4F5061728394A5", "98D67F731BF5451A9402BAA2", True),
]
...
def main() -> None:
    ...
    print("Patched Xcode project for MOB.6 whiteboard files.")
