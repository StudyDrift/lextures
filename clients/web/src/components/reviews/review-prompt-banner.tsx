  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <MessageSquare className="mt-0.5 h-5 w-5 shrink-0 text-accent-fg dark:text-indigo-300" aria-hidden="true" />
        <div>
          <p className="text-sm font-medium text-indigo-900 dark:text-indigo-100">{message}</p>
          <p className="text-xs text-accent-fg/80 dark:text-indigo-300/80">
      ...
      <div className="flex gap-2">
        <button
          type="button"
          onClick={onDismiss}
          className="rounded-lg px-3 py-1.5 text-sm text-accent-fg hover:bg-indigo-100 dark:text-indigo-200 dark:hover:bg-indigo-900/50"
        >
          Not now
        </button>
        <button
          ...
          className="rounded-lg bg-accent-solid px-3 py-1.5 text-sm font-semibold text-white hover:bg-indigo-500"
        >
          Write a review
        </button>
      </div>
