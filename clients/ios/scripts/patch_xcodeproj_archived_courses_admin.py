#!/usr/bin/env python3
"""Add M14.10 Global Archived Courses Admin Swift files to the committed Xcode project."""
...
ENTRIES: list[tuple[str, str, str, str, bool]] = [
    ("LMSFeatureModelsArchivedCoursesAdmin.swift", "8B731C2D3E4F5061728394", "8B731D3E4F5061728394A5", "D7AC7435149B4B17A073AD6F", False),
    ("LMSAPIAdmin.swift", "8B732C2D3E4F5061728394", "8B732D3E4F5061728394A5", "D7AC7435149B4B17A073AD6F", False),
    ("ArchivedCoursesAdminLogic.swift", "8B733C2D3E4F5061728394", "8B733D3E4F5061728394A5", "D7AC7435149B4B17A073AD6F", False),
    ("ArchivedCoursesAdminView.swift", "8B734C2D3E4F5061728394", "8B734D3E4F5061728394A5", "8B72ADM015C6D7E8F901234567", False),
    ("ArchivedCoursesAdminEntryCard.swift", "8B735C2D3E4F5061728394", "8B735D3E4F5061728394A5", "029927E4F879434FA36100DE", False),
    ("ArchivedCoursesAdminLogicTests.swift", "8B736C2D3E4F5061728394", "8B736D3E4F5061728394A5", "8D3F9FB222A34107B54468F2", True),
]

NEW_GROUPS = """
\t\t8B72SET015C6D7E8F901234567 /* Settings */ = {
\t\t\tisa = PBXGroup;
\t\t\tchildren = (
\t\t\t\t8B72ADM015C6D7E8F901234567 /* Admin */,
\t\t\t);
\t\t\tpath = Settings;
\t\t\tsourceTree = "<group>";
\t\t};
...
\t\t\tisa = PBXGroup;
\t\t\tchildren = (
\t\t\t\t8B734D3E4F5061728394A5 /* ArchivedCoursesAdminView.swift */,
\t\t\t);
\t\t\tpath = Admin;
\t\t\tsourceTree = "<group>";
\t\t};
...
SETTINGS_SUBGROUP = "8B72SET015C6D7E8F901234567 /* Settings */"
...
def main() -> None:
    text = PBX.read_text()
    if "8B72SET015C6D7E8F901234567 /* Settings */" not in text:
