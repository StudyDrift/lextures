...
func AllScopes() []Scope {
	scopes := []Scope{
		...
		{ID: "pii:read", Label: "Read PII", Description: "View email and other personally identifiable user fields.", Group: "Users"},
		{ID: "graphql:read", Label: "Read GraphQL schema", Description: "Access the GraphQL schema stub.", Group: "Integrations"},
