...
type ModuleQuizGetQuery struct {
	AttemptID *uuid.UUID `json:"attemptId"`
}
type CreateCourseQuizRequest struct {
	Title string `json:"title"`
}
...
type AdaptiveQuizNextResponse struct {
	Finished  bool                            `json:"finished"`
	Questions []AdaptiveQuizGeneratedQuestion `json:"questions,omitempty"`
...
type QuizStartResponse struct {
	...
	BackNavigationAllowed         bool       `json:"backNavigationAllowed"`
	CurrentQuestionIndex          int32      `json:"currentQuestionIndex"`
	DeadlineAt                    *time.Time `json:"deadlineAt,omitempty"`
	ReducedDistractionMode        bool       `json:"reducedDistractionMode"`
	ExtendedTimeActive            bool       `json:"extendedTimeActive"`
	HintScaffoldingEnabled        bool       `json:"hintScaffoldingEnabled"`
	MisconceptionDetectionEnabled bool       `json:"misconceptionDetectionEnabled"`
	RetakePolicy                  string     `json:"retakePolicy"`
	MaxAttempts                   *int32     `json:"maxAttempts,omitempty"`
	RemainingAttempts             *int32     `json:"remainingAttempts,omitempty"`
}
...
type EnrollmentQuizOverrideUpsertRequest struct {
	QuizID         uuid.UUID `json:"quizId"`
	ExtraAttempts  int32     `json:"extraAttempts"`
	TimeMultiplier *float64  `json:"timeMultiplier"`
}
type QuizCurrentQuestionResponse struct {
	Question       *QuizQuestion `json:"question,omitempty"`
	QuestionIndex  int32         `json:"questionIndex"`
	TotalQuestions uint          `json:"totalQuestions"`
	Completed      bool          `json:"completed"`
}
type QuizAdvanceResponse struct {
	Locked               bool  `json:"locked"`
	CurrentQuestionIndex int32 `json:"currentQuestionIndex"`
	Completed            bool  `json:"completed"`
}
type QuizFocusLossRequest struct {
	EventType  string `json:"eventType"`
	DurationMS *int32 `json:"durationMs"`
}
type QuizFocusLossEventAPI struct {
	ID         uuid.UUID `json:"id"`
	EventType  string    `json:"eventType"`
	DurationMS *int32    `json:"durationMs,omitempty"`
	CreatedAt  time.Time `json:"createdAt"`
}
type QuizFocusLossEventsResponse struct {
	Events []QuizFocusLossEventAPI `json:"events"`
	Total  int64                   `json:"total"`
}
type QuizAttemptHintRequest struct{}
type QuizHintRevealResponse struct {
	Level       *int32  `json:"level,omitempty"`
	Body        *string `json:"body,omitempty"`
	MediaURL    *string `json:"mediaUrl,omitempty"`
	NoMoreHints bool    `json:"noMoreHints,omitempty"`
}
type QuizWorkedExampleStep struct {
	Number      int32   `json:"number"`
	Explanation string  `json:"explanation"`
	Expression  *string `json:"expression,omitempty"`
}
type QuizWorkedExampleResponse struct {
	Title *string                 `json:"title,omitempty"`
	Body  *string                 `json:"body,omitempty"`
	Steps []QuizWorkedExampleStep `json:"steps"`
}
type QuizQuestionResponseItem struct {
	QuestionID            string                     `json:"questionId"`
	SelectedChoiceIndex   *uint                      `json:"selectedChoiceIndex"`
	SelectedChoiceIndices []uint                     `json:"selectedChoiceIndices"`
	TextAnswer            *string                    `json:"textAnswer"`
	MatchingPairs         []QuizMatchingPairResponse `json:"matchingPairs"`
	OrderingSequence      []string                   `json:"orderingSequence"`
	HotspotClick          *QuizHotspotClick          `json:"hotspotClick"`
	NumericValue          *float64                   `json:"numericValue"`
	FormulaLatex          *string                    `json:"formulaLatex"`
	CodeSubmission        *QuizCodeSubmission        `json:"codeSubmission"`
	FileKey               *string                    `json:"fileKey"`
	AudioKey              *string                    `json:"audioKey"`
	VideoKey              *string                    `json:"videoKey"`
}
type QuizMatchingPairResponse struct {
	LeftID  string `json:"leftId"`
	RightID string `json:"rightId"`
}
type QuizHotspotClick struct {
	X float64 `json:"x"`
	Y float64 `json:"y"`
}
type QuizCodeSubmission struct {
	Language string `json:"language"`
	Code     string `json:"code"`
}
type QuizSubmitRequest struct {
	AttemptID       uuid.UUID                  `json:"attemptId"`
	Responses       []QuizQuestionResponseItem `json:"responses"`
	AdaptiveHistory []AdaptiveQuizHistoryTurn  `json:"adaptiveHistory"`
}
...
type QuizResultsScoreSummary struct {
	PointsEarned   float64 `json:"pointsEarned"`
	PointsPossible float64 `json:"pointsPossible"`
	ScorePercent   float32 `json:"scorePercent"`
}
type QuizMisconceptionResultPayload struct {
	ID              uuid.UUID `json:"id"`
	Name            string    `json:"name"`
	RemediationBody *string   `json:"remediationBody,omitempty"`
...
type QuizResultsQuestionResult struct {
	...
	Misconception      *QuizMisconceptionResultPayload `json:"misconception,omitempty"`
}
type QuizResultsResponse struct {
	...
	Questions             []QuizResultsQuestionResult `json:"questions,omitempty"`
}
