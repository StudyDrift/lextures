...
> Implementation plan. Source: mobile parity for board posts. Landscape: [visual-collaboration/README](README.md). Mirrors web [VC.2](../../completed/visual-collaboration/VC.2-posts-and-content-types.md); reuses the board REST post/attachment/unfurl endpoints and native capture (camera, photo library, mic).
