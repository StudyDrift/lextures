...
export function GradeLinkDialog({
  ...
  const fieldClass =
    'mt-1 w-full rounded-lg border border-border-default bg-surface-raised px-3 py-2 text-sm text-fg-default shadow-sm outline-none focus-visible:border-indigo-400 focus-visible:ring-2 focus-visible:ring-indigo-500/30 dark:border-border-default dark:bg-surface-base dark:text-fg-default dark:focus-visible:border-indigo-500'
  ...
  return (
    ...
    >
      <div className="w-full max-w-md overflow-hidden rounded-t-2xl border border-border-default bg-surface-raised shadow-xl sm:rounded-2xl dark:border-border-default dark:bg-surface-base">
        ...
        <div className="flex flex-wrap justify-end gap-2 border-t border-border-default bg-slate-50/80 px-4 py-3 dark:border-border-default/80">
          <button
            type="button"
            className="rounded-lg px-3 py-1.5 text-sm font-medium text-fg-muted hover:bg-surface-sunken dark:text-fg-default dark:hover:bg-surface-overlay"
            onClick={onClose}
            disabled={saving}
          >
          ...
          {link?.countsForGrade ? (
            <button
              type="button"
              className="rounded-lg border border-border-default bg-surface-raised px-3 py-1.5 text-sm font-medium text-fg-muted shadow-sm hover:bg-surface-base dark:border-border-default dark:bg-surface-raised dark:text-fg-default"
          ...
          <button
            type="button"
            className="rounded-lg bg-accent-solid px-3.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 disabled:opacity-50 dark:bg-indigo-500 dark:hover:bg-indigo-400"
