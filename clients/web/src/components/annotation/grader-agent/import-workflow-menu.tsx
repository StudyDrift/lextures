      ...
      <div ref={rootRef} className="relative shrink-0">
        ...
        {open ? (
          <div
            ...
            className="absolute end-0 z-50 mt-1 w-[min(20rem,calc(100vw-2rem))] rounded-xl border border-border-default bg-surface-raised p-4 shadow-lg shadow-slate-900/10 dark:border-border-default dark:bg-surface-raised"
          >
            <p className="text-sm font-semibold text-fg-default">
              {t('gradingAgent.import.title')}
            </p>
            <p className="mt-1 text-xs text-fg-muted">{t('gradingAgent.import.description')}</p>
