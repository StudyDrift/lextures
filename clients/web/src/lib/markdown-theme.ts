...
const PRESET_CLASSES: Record<MarkdownThemePresetId, ThemeClasses> = {
  classic: {
    ...
    ul: 'mt-4 list-disc space-y-2 ps-5 text-[15px] leading-[1.65] text-slate-700',
    ol: 'mt-4 list-decimal space-y-2 ps-5 text-[15px] leading-[1.65] text-slate-700',
    ...
    blockquote: 'mt-4 border-s-4 border-slate-200 ps-4 text-slate-600 italic',
    ...
    table: 'w-full min-w-[20rem] border-collapse text-start text-sm text-slate-800',
  ...
  reader: {
    ...
    ul: 'mt-4 list-disc space-y-2 ps-6 text-[17px] leading-[1.75] text-stone-700',
    ol: 'mt-4 list-decimal space-y-2 ps-6 text-[17px] leading-[1.75] text-stone-700',
    ...
    blockquote: 'mt-6 border-s-[3px] border-amber-300/80 bg-amber-50/50 py-1 ps-5 text-stone-700 not-italic',
    ...
    table: 'w-full min-w-[20rem] border-collapse text-start text-[15px] text-stone-800',
    thead: 'bg-stone-100 text-stone-900',
    th: 'border-b border-stone-200 px-3 py-2.5 text-start text-xs font-semibold uppercase tracking-wide',
  ...
  serif: {
    ...
    ul: 'mt-4 list-disc space-y-2 ps-6 text-[16px] leading-relaxed text-stone-800',
    ol: 'mt-4 list-decimal space-y-2 ps-6 text-[16px] leading-relaxed text-stone-800',
    ...
    blockquote: 'mt-5 border-s-4 border-amber-800/25 ps-5 text-stone-700 italic',
    ...
    table: 'w-full min-w-[20rem] border-collapse text-start text-sm text-stone-900',
    thead: 'bg-stone-100',
  ...
  contrast: {
    ...
    ul: 'mt-3 list-disc space-y-1.5 ps-5 text-[15px] font-medium leading-relaxed text-black',
    ol: 'mt-3 list-decimal space-y-1.5 ps-5 text-[15px] font-medium leading-relaxed text-black',
    li: 'marker:text-black',
    a: 'font-bold text-black underline decoration-2 underline-offset-4 hover:bg-yellow-200',
    blockquote: 'mt-4 border-s-8 border-black bg-slate-100 py-2 ps-4 font-semibold text-black',
    ...
    table: 'w-full min-w-[20rem] border-collapse border border-black text-start text-sm text-black',
  ...
  night: {
    ...
    ul: 'mt-3 list-disc space-y-1.5 ps-5 text-[15px] leading-relaxed text-slate-300',
    ol: 'mt-3 list-decimal space-y-1.5 ps-5 text-[15px] leading-relaxed text-slate-300',
    li: 'marker:text-slate-500',
    a: 'font-medium text-sky-400 underline decoration-sky-600 underline-offset-2 hover:text-sky-300',
    blockquote: 'mt-4 border-s-4 border-slate-600 ps-4 text-slate-400 italic',
    ...
    table: 'w-full min-w-[20rem] border-collapse text-start text-sm text-slate-200',
  ...
  accent: {
    ...
    ul: 'mt-3 list-disc space-y-1.5 ps-5 text-[15px] leading-relaxed text-slate-700',
    ol: 'mt-3 list-decimal space-y-1.5 ps-5 text-[15px] leading-relaxed text-slate-700',
    ...
    blockquote: 'mt-4 border-s-4 border-violet-400 bg-violet-50/80 py-1 ps-4 text-violet-950',
    ...
    table: 'w-full min-w-[20rem] border-collapse text-start text-sm text-violet-950',
