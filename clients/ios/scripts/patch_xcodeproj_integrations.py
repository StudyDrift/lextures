#!/usr/bin/env python3
"""Add M14.1 Account Integrations Swift files to the committed Xcode project."""
...
ENTRIES: list[tuple[str, str, str, str, bool]] = [
    ("LMSFeatureModelsAccountIntegrations.swift", "8B721C2D3E4F5061728394", "8B721D3E4F5061728394A5", "0192C31B7A97444D9236A8A1", False),
    ("LMSAPIAccountIntegrations.swift", "8B722C2D3E4F5061728394", "8B722D3E4F5061728394A5", "0192C31B7A97444D9236A8A1", False),
    ("AccountIntegrationsLogic.swift", "8B723C2D3E4F5061728394", "8B723D3E4F5061728394A5", "0192C31B7A97444D9236A8A1", False),
    ("IntegrationsView.swift", "8B724C2D3E4F5061728394", "8B724D3E4F5061728394A5", "8B72INT015C6D7E8F901234567", False),
    ("IntegrationsEntryCard.swift", "8B725C2D3E4F5061728394", "8B725D3E4F5061728394A5", "4CC73DD0F8E3490486591CC7", False),
    ("AccountIntegrationsLogicTests.swift", "8B726C2D3E4F5061728394", "8B726D3E4F5061728394A5", "FB04F8A19314441A8AB2F273", True),
]

NEW_GROUPS = """
\t\t8B72INT015C6D7E8F901234567 /* Settings */ = {
\t\t\tisa = PBXGroup;
\t\t\tchildren = (
\t\t\t\t8B724D3E4F5061728394A5 /* IntegrationsView.swift */,
\t\t\t);
\t\t\tpath = Settings;
\t\t\tsourceTree = "<group>";
\t\t};
...
SETTINGS_SUBGROUP = "8B72INT015C6D7E8F901234567 /* Settings */"
PROFILE_GROUP = "4CC73DD0F8E3490486591CC7"
CORE_LMS_GROUP = "0192C31B7A97444D9236A8A1"
...
def main() -> None:
    text = PBX.read_text()
    if "8B72INT015C6D7E8F901234567 /* Settings */" not in text:
        text = insert_before(text, "/* End PBXGroup section */", NEW_GROUPS)
        text = insert_into_children(text, FEATURES_GROUP, SETTINGS_SUBGROUP)
