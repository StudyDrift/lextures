...
> Implementation plan. Source: [docs/plan/seo/audit.md](../../plan/seo/audit.md) §S4 (F-21) and
> [research §9](../../plan/seo/research.md#9-measurement-in-2026).
...
| **Implementation** | Completed 2026-08-11; external source connections and September observations remain operational rollout work |
...
([research §9](../../plan/seo/research.md#9-measurement-in-2026)). We are about to spend twelve months and real money
...
- **Privacy & Compliance** — IP anonymisation on; no PII in GA4 custom dimensions; the hidden source
  ...
  limit and appear in the RoPA ([S05](../../plan/standards/S05-ropa-data-inventory-mapping.md)); if a consent
...
- Existing files: `www/index.html` (:29-37 GA4), `www/src/lib/institution-inquiry-api.ts`,
  `www/src/pages/request-information-page.tsx`, `www/src/pages/get-started-page.tsx`
- Audit findings: [F-21](../../plan/seo/audit.md#f-21-ga4-is-installed-and-configured-for-the-wrong-era),
  [F-7](../../plan/seo/audit.md#f-7-no-bing--indexnow-path)
- Research: [§9 Measurement in 2026](../../plan/seo/research.md#9-measurement-in-2026),
  [§1](../../plan/seo/research.md#1-the-structural-shift-retrieval-replaced-ranking)
...
- Related plans: [SEO.2](SEO.2-crawler-access-sitemaps-and-llms-txt.md),
  ...
  [S05 — RoPA / data mapping](../../plan/standards/S05-ropa-data-inventory-mapping.md)
