...
> Completed 2026-08-11. The marketing site now publishes 64 help articles in 16 categories with categorized routes, legacy redirects, lazy static search, markdown siblings, sitemap and llms.txt coverage, freshness enforcement, and a synthetic screenshot workflow.
