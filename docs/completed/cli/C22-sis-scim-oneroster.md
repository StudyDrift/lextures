...
> CLI parity plan. Source: `registerSISRoutes`, `registerSCIMRoutes` (`/scim/*`), `oneroster_admin.go` + `/oneroster/v1p2/*`, `admin/lrs-config`. Baseline: `clients/cli/cmd/sis.go`, `scim.go`, `oneroster.go`, `lrs.go`, `sis_scim_oneroster_logic.go`, `sis_scim_oneroster_test.go`.
