...
> Completed implementation. Source: [docs/plan/marketing-content/README.md](../../plan/marketing-content/README.md) §Plans; supersedes
> the filesystem-walking `www/scripts/generate-docs-search.mjs` build and the hard-coded route→article
> mapping in `support_widget_http.go` with a DB-backed, tiered resolution.
