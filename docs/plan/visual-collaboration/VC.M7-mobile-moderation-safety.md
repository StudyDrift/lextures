...
> Implementation plan. Source: mobile parity for board moderation/safety. Landscape: [visual-collaboration/README](README.md). Mirrors web [VC.7](../../completed/visual-collaboration/VC.7-moderation-safety-governance.md); consumes the moderation REST endpoints and honors lock/freeze/approval state (including over the VC.M4 WebSocket).
...
- Standards: [S02 retention](../standards/S02-data-retention-deletion-engine.md), [S03 incident response](../standards/S03-global-breach-notification-incident-response.md), [S08 children's privacy](../standards/S08-childrens-privacy-age-assurance-design-codes.md).
