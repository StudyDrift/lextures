...
// 257 KiB + 2 KiB slack — Linux CI gzip can exceed macOS/local builds for the same sources.
const entryMaxBytes = Number(process.env.ENTRY_MAX_JS_GZIP_BYTES ?? 257 * 1024 + 2 * 1024)
